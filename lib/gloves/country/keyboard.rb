  ...
  module Country
    ...
    "KBD_DISABLE_CAPSLOCK"
      ...
      def self.read(params)
        ...
        # read config files
        sysconfig_keyboard	= ConfigAgent::Country::Keyboard.new.read({})
    ...
    params.each do |key, value|
      ...
      sysconfig_params["YAST_KEYBOARD"]     = (params["current_kbd"] || "") + "," + (params["kb_model"] || "")
          ...
          ret	= ConfigAgent::Country::Keyboard.new.write(sysconfig_params)
        end
        ...
        if config["apply"] && keymap
          ...
          if File.exists?("/usr/sbin/xkbctrl")
            ...
            ConfigAgent::Country::Setxkbmap.new.execute({
                "DISPLAY" => ENV["DISPLAY"] || "",
