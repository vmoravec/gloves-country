...
require "rubygems"
require 'config_agent/country/adjtime'
require 'config_agent/country/clock'
...
module Gloves
  module Timezone
	...
	params.each do |key, value|
        ...
        if sysconfig_params.has_key? "HWCLOCK"
          adjtime_f = ConfigAgent::Country::Adjtime.new
        ...
        ret	= ConfigAgent::Country::Clock.new.write(sysconfig_params)
      end
  ...
  private
    ...
    def self.read_sysconfig
      read = ConfigAgent::Country::Clock.new.read({})

      adjtime = ConfigAgent::Country::Adjtime.new.read({})
